...
export class ArticleService {
  async generateArticle(input: ArticleGenerateOptions): Promise<Article> {
    ...
    logger.info({
      outlineId,
      hasDeepResearch: !!sectionResearch || !!allSources,
    ...
    // Note: Toplists are now handled as proper sections in the outline
    // They are generated by the section writer when a section has a toplistId
